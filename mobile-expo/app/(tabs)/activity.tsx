        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#0d0d0d' }}>
            <View style={{ flex: 1, paddingHorizontal: 14, paddingTop: 14 }}>
                ...
                <View style={{ marginBottom: 14 }}>
                    <Text style={{ fontSize: 17, fontWeight: '700', color: '#fff' }}>Recent Activity</Text>
                    <Text style={{ fontSize: 11, color: '#888', marginTop: 2 }}>Updates from your projects</Text>
                </View>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                                ...
                                >
                                    ...
                                    <View style={{ flex: 1 }}>
                                        ...
                                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 }}>
                                            ...
                                            <Text style={{ fontSize: 9, color: '#555' }}>{activity.timestamp}</Text>
                                        </View>
                                    </View>
                                </View>
                            );
                    ...
                    {mockActivities.length === 0 && (
                        <View style={{ marginTop: 40, alignItems: 'center' }}>
                            ...
                            <Text style={{ fontSize: 12, color: '#888', marginTop: 8 }}>No recent activity</Text>
                        </View>
                    )}
                </ScrollView>
            </View>
