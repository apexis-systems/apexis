...
export let globalActiveType: 'photo' | 'document' | 'photos' | 'documents' | null = null;

export const setActiveProjectContext = (projectId: string | null, folderId: string | null = null, type: 'photo' | 'document' | 'photos' | 'documents' | null = null) => {
