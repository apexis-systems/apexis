                            ...
                            <div className="flex-1 p-8 sm:p-14 border-b md:border-b-0 md:border-r border-border/40 flex flex-col">
                                ...
                                <div className="space-y-8 flex-1">
                                    ...
                                    <div className="flex items-start gap-5">
                                        ...
                                        <p className="text-[17px] text-foreground leading-snug pt-0.5">Go to <span className="font-semibold text-foreground">Settings &gt; Connected Devices &gt; Scan to Connect</span></p>
                                    </div>
                                    <div className="flex items-start gap-5">
