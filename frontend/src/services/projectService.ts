...
export const removeProjectMember = async (
    ...
    try {
        let url = `/projects/${projectId}/members/${userId}`;
        const params: string[] = [];
...
export const getProjectPhotosPaginated = async (projectId: string | number, page: number = 1, limit: number = 36, sort?: string) => {
    try {
