...
import { uploadFile, uploadScans, listFiles, deleteFile, viewFile, bulkUpdateFiles, updateFile, archiveFile, unarchiveFile, downloadFile, markFileSeen, confirmScreenshot } from "../controllers/fileController.ts";
