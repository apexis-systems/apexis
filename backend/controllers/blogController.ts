...
function formatBlogResponse(record: any, req?: Request) {
    ...
    return {
        ...
        primaryKeywords: json.primaryKeywords || json.primary_keywords || [],
        secondaryKeywords: json.secondaryKeywords || json.secondary_keywords || [],
...
export const createBlog = async (req: Request, res: Response) => {
    try {
        ...
        const newRecord = await blogs.create({
            ...
            primary_keywords: Array.isArray(primaryKeywords) ? primaryKeywords : [],
...
export const updateBlog = async (req: Request, res: Response) => {
    try {
        ...
        await record.update({
            ...
            ...(primaryKeywords !== undefined && { primary_keywords: Array.isArray(primaryKeywords) ? primaryKeywords : [] }),
            ...(secondaryKeywords !== undefined && { secondary_keywords: Array.isArray(secondaryKeywords) ? secondaryKeywords : [] }),
